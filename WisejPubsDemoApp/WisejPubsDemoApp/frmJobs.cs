...
namespace WisejPubsDemoApp
{
    public partial class frmJobs : Form
    {
        ...
        private void InitDataContext(bool ForceFormInit = false)
        {
            ...
            this.dbT_Dbo_Jobs.DbC_job_id.BoundControls.Add(this.txt_job_id, "text", BasicDAL.BindingBehaviour.ReadAddNew );
            this.dbT_Dbo_Jobs.DbC_job_desc.BoundControls.Add(this.txt_job_desc, "text");

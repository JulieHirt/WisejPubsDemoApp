...
namespace WisejPubsDemoApp
{
    public partial class frmPubsInfo : Form
    {
        ...
        private void InitDataContext(bool ForceFormInit = false)
        {
            ...
            {
                this.uploadLogo.Enabled = false;
                this.uploadLogo.ToolTipText = this.appConfig.PublicDemoMessage;
            }
            ...
            this.dbT_Dbo_Pub_Info.DbC_pub_id.BoundControls.Add(this.txt_pub_id, "text", BasicDAL.BindingBehaviour.ReadAddNew );
        ...
        private void dataNavigator1_eSave()
        {
            ...
            if (this.dataNavigator1.DataGridActive == false)
            {
                this.dbT_Dbo_Pub_Info.DbC_logo.Value = BasicDAL.Utilities.ByteArrayHelper.imageToByteArray(this.pict_logo.Image);

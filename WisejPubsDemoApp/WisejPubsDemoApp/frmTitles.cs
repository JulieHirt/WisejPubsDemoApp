...
namespace WisejPubsDemoApp
{
    public partial class frmTitles : Form
    {
        ...
        private void InitDataContext(bool ForceFormInit = false)
        {
            ...
            this.dbT_Dbo_Titles.DbC_title_id.BoundControls.Add(this.txt_title_id, "text",BasicDAL.BindingBehaviour.ReadAddNew );
        ...
        private void dgv_TitleAuthors_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            if (this.dgv_TitleAuthors.CurrentCell.OwningColumn.Name == this.dgvc_qbe_authors.Name)
            {
                ...
                QBEForm.BoundControls.Add(QBEDbObject.DbC_au_id, this.dgv_TitleAuthors.CurrentCell.OwningRow[this.dgvc_au_id.Name], "value");
                QBEForm.BoundControls.Add(QBEDbObject.DbC_au_fullname, this.dgv_TitleAuthors.CurrentCell.OwningRow[this.dgvc_au_fullname.Name], "value");
                QBEForm.ShowQBE(this);
            }

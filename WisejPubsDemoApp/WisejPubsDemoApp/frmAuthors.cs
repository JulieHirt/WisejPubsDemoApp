...
namespace WisejPubsDemoApp
{
    public partial class frmAuthors : Form
    {
        ...
        private void InitDataContext()
        {
            ...
            this.dbT_Dbo_Authors.DbC_au_id.BoundControls.Add(this.txt_au_id , "text",  BasicDAL.BindingBehaviour.ReadAddNew );
        ...
        private void frmAuthors_KeyDown(object sender, KeyEventArgs e)
        {

...
Public Class DataNavigator
    ...
    Private _RecordLabelNewRow As String = "New Row"

    Private _DataBoundCompleted As Boolean = False
    Public Property DataBoundCompleted() As Boolean
        Get
    ...
    Private _Language As String = "it-IT"
    ...
    Property DataGrid() As Wisej.Web.DataGridView
        ...
        Set(ByVal value As Wisej.Web.DataGridView)
            _DataGrid = value
            If Me.DbObject IsNot Nothing And _DataGrid IsNot Nothing Then
                _DataGrid.DataSource = Me.DbObject.DataTable
            End If
        ...
        If Me._DbObject IsNot Nothing And Me.RecordLabel.Visible = True Then
            ...
            Select Case Me._DataGridActive
                Case Is = False
                    ...
                    Else
                        Me.RecordLabel.Text = _RecordLabelNewRow
                    End If
...
Public Class ListViewColumns
    ...
    Public Sub Add(ByVal DbColumn As BasicDAL.DbColumn, ByVal FriendlyName As String, Optional ByVal DisplayFormat As String = "", Optional ByVal ColumnType As DataGridListViewColumnType = DataGridListViewColumnType.Undefined, Optional ByVal Width As Integer = 0)

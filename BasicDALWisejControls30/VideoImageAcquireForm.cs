...
namespace BasicDALWisejControls
{
    public partial class VideoImageAcquireForm
    {
        ...
        private int mFile_ContentLenght = 0;
        private int mCamera_ContentLenght = 0;
        private int mWeb_ContentLenght = 0;
        ...
        {
            return BasicDAL.Utilities.imageToByteArray(PictureBoxFile.Image);
        }
        ...
        {
            var CameraForm = new BasicDALWisejControls.CameraForm();
            ...
            CameraForm.ObjectTypeToAcquire = (BasicDALWisejControls.CameraForm.ObjectTypesToAcquire)mObjectTypeToAcquire;
            CameraForm.ShowDialog();
            PictureBoxCamera.Visible = false;
            if ((int)CameraForm.AcquiredObjectType != (int)AcquiredObjectTypes.Null)
            {
                ...
                {
                    case BasicDALWisejControls.CameraForm.AcquiredObjectTypes.Video:
                        {
                            PictureBoxCamera.Visible = false;
                    ...
                    case BasicDALWisejControls.CameraForm.AcquiredObjectTypes.Image:
                        {
                            VideoCamera.Visible = false;
                            VideoCamera.SourceURL = "";
                            mCamera_AcquiredObjectType = AcquiredObjectTypes.Image;
                            PictureBoxCamera.Image = this.SafeImageFromFile(CameraForm.RealFileName);

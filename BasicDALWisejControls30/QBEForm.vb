...
Public Class QBEForm
    ...
    Public Sub ShowReportPDF(ByVal Report As QBEReport)
        ...
        Else
            ...
            Wisej.Web.MessageBox.Show(ReportMsg & ". ReportPath did not exist!", Me.Text, Wisej.Web.MessageBoxIcon.Error)
            Return
        End If
        ...
        If System.IO.File.Exists(ReportFileName) = False Then
            Wisej.Web.MessageBox.Show(ReportMsg & ". The report file did not exist!", Me.Text, Wisej.Web.MessageBoxIcon.Error)
            Return
        End If
        ...
        Catch ex As Exception
            Wisej.Web.MessageBox.Show(ReportMsg & vbCrLf & "Error loading report: " & ex.Message, Me.Text, Wisej.Web.MessageBoxIcon.Error)
            Return
        End Try
        ...
        Try
            ...
            Next CrTable
        Catch ex As Exception
            Wisej.Web.MessageBox.Show(ReportMsg & vbCrLf & "Error on DB connection setup: " & ex.Message, Me.Text, Wisej.Web.MessageBoxIcon.Error)
            Return
        End Try
        ...
        Try
            ...
            Next section
        Catch ex As Exception
            Wisej.Web.MessageBox.Show(ReportMsg & vbCrLf & "Error on DB connection setup for subreport: " & ex.Message, Me.Text, Wisej.Web.MessageBoxIcon.Error)
            Return
        End Try
        ...
        Catch ex As Exception
            Wisej.Web.MessageBox.Show(ReportMsg & vbCrLf & ErrMsg2 & vbCrLf & "Error loading data!" & ex.Message & vbCrLf & ex.StackTrace, Me.Text, Wisej.Web.MessageBoxIcon.Error)
            Exit Sub
        End Try
    ...
    Public Sub SetLanguage(ByVal Language As String)
        ...
        Select Case Language.ToLower().Trim()
            Case "it-it"
                ...
                TabReportsText = "Stampe Disponibili"
                ...
                ReportGridReportNameHeaderText = "Stampa"
                ReportGridReportDescriptionHeaderText = "Descrizione Stampa"
    ...
    Private Sub QBEForm_Resize(sender As Object, e As EventArgs) Handles Me.Resize
        ...
        Select Case Me.QueryGrid.Rows.Count
            ...
            Case < 5
                Me.SplitContainer1.SplitterDistance = Height - (Me.QueryGrid.Rows.Count * Me.QueryGrid.DefaultRowHeight * 2)
            Case Else
    ...
    Private Sub btnEsporta_Click(sender As Object, e As EventArgs) Handles btnEsporta.Click
        ...
        For Each Column As DataGridViewColumn In Me.ResultGrid.Columns
            If Column.Visible = True Then
                DbColumns.Add(Me.DbObject.GetDbColumnByDbColumnPropertyName(Column.Tag))
            End If
        Next
